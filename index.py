...
class GameInfo:
    ...
    def __init__(self):
        titleider: str = "40042"
        secretkey: str = "TSM39OUDYDU7QW7FI63HQ35WRENAUUDQHFF5GUXWKXRHQ958B4"
        self.ApiKey: str = "OC|9721467137979759|3375f33673a6d1cc21bd4b1a9ad4e0c3"
...
titleider = "40042"
secretkey = "TSM39OUDYDU7QW7FI63HQ35WRENAUUDQHFF5GUXWKXRHQ958B4"
settings.ApiKey = "OC|9721467137979759|3375f33673a6d1cc21bd4b1a9ad4e0c3"
...
def titled_data():
    return jsonify({"MOTD":"<color=red>WELCOME TO PROJECT HAS!</color>\n\n\n<color=orange>CHRISTMAS 2024!</color>\n\n\n<color=blue>CHANGE UR NAME FROM GORILLA#### SINCE ITS BANNABLE</color>\n\n<color=yellow>DISCORD: discord.gg/projecthas</color>"})
